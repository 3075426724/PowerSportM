...
Page({
	...
	onLoad: async function (options) {
		...
		if (!pageHelper.getOptions(this, options, 'unitId')) return;
		...
		this.setData({
			...
			this.setData({
				formUnitId: this.data.unitId,
				unitTitle: AdminUnitBiz.getUnitTitle(this.data.unitIdOptions, this.data.unitId)
			});
		});
	},
	...
	bindFormSubmit: async function () {
		...
		data.unitTitle = AdminUnitBiz.getUnitTitle(this.data.unitIdOptions, this.data.formUnitId);
