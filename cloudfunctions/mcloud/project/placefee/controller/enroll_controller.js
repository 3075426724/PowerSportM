...
class EnrollController extends BaseProjectController {
	...
	async getUnitCateList() {
		...
		return await service.getUnitCateList(input.unitId);
	...
	async getAllEnroll() {
		...
		let service = new EnrollService();
		return await service.getAllEnroll(this._userId, input.unitId, input.cateId, input.day); 
	}
	...
	async getUsedByDay() {
		...
		let service = new EnrollService();
		let list = await service.getUsedByDay(input.unitId, input.cateId, input.day);
