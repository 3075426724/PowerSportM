...
AdminModel.DB_STRUCTURE = {
	...
	ADMIN_TYPE: 'int|true|default=0|comment=类型 0=普通管理员 1=超级管理员, 2=店铺超管 3=店铺普通管理员',

	ADMIN_UNIT_ID: 'string|false|comment=所属场馆',
	ADMIN_UNIT_TITLE: 'string|false|comment=所属场馆冗余',
